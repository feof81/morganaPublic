...
int main(int argc, char *argv[])
{
  ...
  //Matrix matrixAB------------------------------------------------------------
  Epetra_CrsMatrix matrixAB(Copy, rowMapA, colMapB, 1);
  ...
  //Matrix matrixBA------------------------------------------------------------
  Epetra_CrsMatrix matrixBA(Copy, rowMapB, colMapA, 1);
  ...
  //Matrix matrixBB------------------------------------------------------------
  Epetra_CrsMatrix matrixBB(Copy, rowMapB, colMapB, 1);
  ...
  //assembler.printToFile("matrix.mat");
  //cout << *assembler.getRowMap() << endl;
  //cout << *assembler.getColMap() << endl;
