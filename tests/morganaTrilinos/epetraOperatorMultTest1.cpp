...
int main(int argc, char *argv[])
{
  ...
  //Matrix matrixB-------------------------------------------------------------
  Teuchos::RCP<Epetra_CrsMatrix> matrixB(new Epetra_CrsMatrix(Copy, rowMapB, 1));
  ...
  Teuchos::RCP<Epetra_MultiVector> Y(new Epetra_MultiVector(rowMapB,1));
  ...
  //Operator testing
  epetraOperatorMult op(matrixB,matrixA);
  op.Apply(*X,*Y);
