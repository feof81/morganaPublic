...
int main(int argc, char *argv[])
{
  ...
  //Test support
  typedef supportLagrange2d<GEOSHAPE,PMAPTYPE> SUPPORT;
  
  SUPPORT support(grid2d,connectGrid2d,grid1d,connectGrid1d);  
  support.setElement2d(2);
  support.setLocalEdge(1);
  
  point3d Yd(0.5, 0.0, 0.0);
  
  cout << "Yv       : " << support.mapVolumeY(Yd);
  cout << "N        : " << support.computeNormal(Yd);
  cout << "Boundary : " << support.isBoundary() << endl;
  cout << "El1      : " << support.getElement1d() << endl;
  cout << "Y1d      : " << support.mapSurfaceY(Yd) << endl;
