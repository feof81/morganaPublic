...
int main(int argc, char *argv[])
{
  ...
  if(world.rank() == 0)
  {
    ...
    elList.push_back(li, pMapItemShare(1,1,false,true));
    li.setGeoId(1); li(1) = 2; li(2) = 3;
    elList.push_back(li, pMapItemShare(2,2,false,true));
  ...
  else
  {
    ...
    elList.push_back(li, pMapItemShare(1,3,false,true));
    li.setGeoId(2); li(1) = 4; li(2) = 1;
    elList.push_back(li, pMapItemShare(2,4,false,true));
