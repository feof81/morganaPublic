...
int main(int argc, char *argv[])
{
  ...
  string local3d     = "init3dTest6_localMesh3d_" + num2str(world.rank()) + "pid.inp";
  UInt pid           = world.rank();
  ...
  string local2d = "init3dTest6_localMesh2d_" + num2str(world.rank()) + "pid.inp";
  ...
  meshPrinter3d.paraviewSerial("init3dTest6_globalMesh3d.inp",globalGrid3d);
  ...
  meshPrinter2d.paraviewSerial("init3dTest6_globalMesh2d.inp",globalGrid2d);
}
