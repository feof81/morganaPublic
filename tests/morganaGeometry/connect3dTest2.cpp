...
int main(int argc, char *argv[])
{
  ...
  if(world.rank() == 0)
  {
    ...
    nodes3d.reserve(4);
    nodes3d.push_back(point3d(0.0, 0.0, 0.0),pMapItem(1,1)); nodes3d.getMapL(1).setPid(0);
    nodes3d.push_back(point3d(1.0, 0.0, 0.0),pMapItem(2,2)); nodes3d.getMapL(2).setPid(0);
    nodes3d.push_back(point3d(1.0, 1.0, 0.0),pMapItem(3,3)); nodes3d.getMapL(3).setPid(0);
    nodes3d.push_back(point3d(0.5, 0.5, 1.0),pMapItem(4,5)); nodes3d.getMapL(4).setPid(0);
    ...
    nodes2d.reserve(4);
    nodes2d.push_back(point3d(0.0, 0.0, 0.0),pMapItem(1,5));
    nodes2d.push_back(point3d(1.0, 0.0, 0.0),pMapItem(2,4));
    nodes2d.push_back(point3d(1.0, 1.0, 0.0),pMapItem(3,3));
    nodes2d.push_back(point3d(0.5, 0.5, 1.0),pMapItem(4,1));
  ...
  else
  {
    ...
    nodes3d.reserve(4);
    nodes3d.push_back(point3d(0.0, 0.0, 0.0),pMapItem(1,1)); nodes3d.getMapL(1).setPid(1);
    nodes3d.push_back(point3d(1.0, 1.0, 0.0),pMapItem(2,3)); nodes3d.getMapL(2).setPid(1);
    nodes3d.push_back(point3d(0.0, 1.0, 0.0),pMapItem(3,4)); nodes3d.getMapL(3).setPid(1);
    nodes3d.push_back(point3d(0.5, 0.5, 1.0),pMapItem(4,5)); nodes3d.getMapL(4).setPid(1);
    nodes3d.updateFinder();
    ...
    nodes2d.reserve(4);
    nodes2d.push_back(point3d(0.0, 0.0, 0.0),pMapItem(1,5));
    nodes2d.push_back(point3d(1.0, 1.0, 0.0),pMapItem(2,3));
    nodes2d.push_back(point3d(0.0, 1.0, 0.0),pMapItem(3,2));
    nodes2d.push_back(point3d(0.5, 0.5, 1.0),pMapItem(4,1));
    nodes2d.updateFinder();
