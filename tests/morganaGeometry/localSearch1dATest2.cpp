...
int main(int argc, char *argv[])
{
  ...
  typedef localSearch1dA<GEOSHAPE1D,ELMAP,NODEMAP> SEARCH1D;
  ...
  point3d P, Pmin(0.0, 0.0, 1.0), Pmax(1.0, 0.0, 0.0);
  ...
  geoMapInterface<GEOSHAPE1D> globMapper;
  ...
  for(UInt i=0; i <= steps; ++i)
  {
    ...
    points = grid1d->getElementNodesL(outData.getElMap().getLid());
