...
int main(int argc, char *argv[])
{
  ...
  string meshFile  = "../geometries/quad2d/quad2dA.neu";
  string colorFile = "../geometries/quad2d/quad2dA_color.neu";
  ...
  string     local2d = "init2dTest5_localMesh2d_" + num2str(world.rank()) + "pid.inp";
  UInt           pid = world.rank();
  ...
  string local1d = "init2dTest5_localMesh1d_" + num2str(world.rank()) + "pid.inp";
  ...
  meshPrinter2d.paraviewSerial("init2dTest5_globalMesh2d.inp",globalGrid2d);
  ...
  meshPrinter1d.paraviewSerial("init2dTest5_globalMesh1d.inp",globalGrid1d);
