...
int main(int argc, char *argv[])
{
  ...
  if(world.rank() == 0)
  {
    ...
    nodeMap.setLid(3); nodeMap.setGid(3); nodeMap.setPid(0);
    nodes.push_back(point3d(1.0, 1.0, 0.0),nodeMap);
  ...
  else
  {
    ...
    elMap.setLid(1); elMap.setGid(1); elMap.setPid(1);
    nodes.push_back(point3d(0.0, 0.0, 0.0),elMap);
    elMap.setLid(2); elMap.setGid(3); elMap.setPid(1);
    nodes.push_back(point3d(1.0, 1.0, 0.0),elMap);
    elMap.setLid(3); elMap.setGid(4); elMap.setPid(1);
  ...
  cout << "Check: " << lineManipulator.check(grid1d) << endl;
}
