...
int main(int argc, char *argv[])
{
  ...
  string local3d     = "init3dTest7_localMesh3d_" + num2str(world.rank()) + "pid.inp";
  UInt pid           = world.rank();
  ...
  string local2d = "init3dTest7_localMesh2d_" + num2str(world.rank()) + "pid.inp";
  ...
  meshPrinter3d.paraviewSerial("init3dTest7_globalMesh3d.inp",globalGrid3d);
  ...
  meshPrinter2d.paraviewSerial("init3dTest7_globalMesh2d.inp",globalGrid2d);
}
