...
int main(int argc, char *argv[])
{
  ...
  if(world.rank() == 0)
  {
    ...
    nodes.push_back(point3d(1.0, 1.0, 0.0),pMapItemShare(3,3));
    nodes.push_back(point3d(0.0, 1.0, 0.0),pMapItemShare(4,4));
    nodes.push_back(point3d(0.5, 0.5, 1.0),pMapItemShare(5,5));
    nodes.updateFinder();
  ...
  else
  {
    //Nodes
    nodes.reserve(1);
    nodes.push_back(point3d(0.5, 0.5, -1.0),pMapItemShare(1,6));
    nodes.updateFinder();
    
    //Elements
    elList.reserve(2);
    
    tet.setGeoId(2); tet(1) = 1; tet(2) = 2; tet(3) = 3; tet(4) = 6;
    elList.push_back(tet, pMapItem(1,3));
    tet.setGeoId(2); tet(1) = 1; tet(2) = 3; tet(3) = 4; tet(4) = 6;
