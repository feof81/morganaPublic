...
int main(int argc, char *argv[])
{
  ...
  if(world->rank() == 1)
  {
    ...
    item.setPid(0); item.setLid(3); item.setGid(3); sVector.push_back(item,3.0,false);
    item.setPid(0); item.setLid(4); item.setGid(4); sVector.push_back(item,4.0,false);
