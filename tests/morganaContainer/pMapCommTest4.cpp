...
int main(int argc, char *argv[])
{
  ...
  if(world->rank() == 0)
  {
    item.setLid(1); item.setGid(13); sMap->push_back(item);
    item.setLid(2); item.setGid(14); sMap->push_back(item);
    item.setLid(3); item.setGid(15); sMap->push_back(item);
    item.setLid(4); item.setGid(16); sMap->push_back(item);
    item.setLid(5); item.setGid(17); sMap->push_back(item);
    item.setLid(6); item.setGid(18); sMap->push_back(item);
