...
int main(int argc, char *argv[])
{
  ...
  std::set<UInt> activeGeoIds, majorGeoIds;
  activeGeoIds.insert(1);
  activeGeoIds.insert(2);
  activeGeoIds.insert(3);
  activeGeoIds.insert(4);
  activeGeoIds.insert(5);
  activeGeoIds.insert(6);
  activeGeoIds.insert(7);
  activeGeoIds.insert(8);
  activeGeoIds.insert(9);
  activeGeoIds.insert(10);
  activeGeoIds.insert(11);
  
  majorGeoIds.insert(11);
