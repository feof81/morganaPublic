...
#include "interpolatorNodalSurface3d.hpp"
...
int main(int argc, char *argv[])
{
  ...
  sourceInit.gmMesh_to_stdB(meshFile, false);
  ...
  RCP<MESH2D>           grid2d = sourceInit.getGrid2d();
  RCP<CONNECT2D> connectGrid2d = sourceInit.getConnectGrid2d();
  ...
  //Interpolator-----------------------------------------------------------------------------------
  interpolatorNodalSurface3d<SOURCE_FIELD,TARGET_FIELD> interpolator(world);
