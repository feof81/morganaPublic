...
int main(int argc, char *argv[])
{
  ...
  feStaticField3d<FETYPE,DOFTYPE,dms3d_vectMajor,dms3d_geoIdMode> cloneField3d;
  cloneField3d.clone(field3d);
  ...
  P.setX(0.3); P.setY(0.3); P.setZ(0.0);
  ...
  if(pid == dataVect(1).getElMap().getPid())
  {
    ...
    cloneField3d.evalL(elL,Y,Vc);
    cout << "pid " << pid << " original " << V;
    cout << "pid " << pid << " clone    " << Vc;
  }
}
