...
#include "feP1BP13d.hpp"
#include "pMapItem.h"

int main(int argc, char *argv[])
{
  typedef pMapItem                 PMAPTYPE;
  typedef feP1BP13d<PMAPTYPE>      FETYPE;
  ...
  nodes(1) = point3d(1.0, 0.0, 0.0);
  nodes(2) = point3d(0.0, 0.0, 0.0);
  nodes(3) = point3d(0.0, 0.0, 1.0);
  nodes(4) = point3d(0.0, 1.0, 0.0);
