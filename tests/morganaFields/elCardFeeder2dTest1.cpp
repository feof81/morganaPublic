...
int main(int argc, char *argv[])
{
  ...
  meshPrinter2d.paraviewSerial("globalMesh2d.inp",globalGrid2d);
  
  
  //Test the feeder
  UInt el = 1;
  
  elCardFeeder2d<GEOSHAPE2D,ELMAP> elFeeder(grid2d,connectGrid2d);
  elCard2d<GEOSHAPE2D,ELMAP> elCard = elFeeder.getCardLocal(el);
