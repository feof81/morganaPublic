...
{  
  ...
  point3d X0 = (nodes(1) + nodes(2) + nodes(3) + nodes(4)) / 4.0;
  ...
  theta = point3d::dot(K1,X-X0); Vexc += komplex(cos(theta),sin(theta));
  theta = point3d::dot(K2,X-X0); Vexc += komplex(cos(theta),sin(theta));
  theta = point3d::dot(K3,X-X0); Vexc += komplex(cos(theta),sin(theta));
  theta = point3d::dot(K4,X-X0); Vexc += komplex(cos(theta),sin(theta));
  theta = point3d::dot(K5,X-X0); Vexc += komplex(cos(theta),sin(theta));
  theta = point3d::dot(K6,X-X0); Vexc += komplex(cos(theta),sin(theta));
  ...
  theta = point3d::dot(K1,X-X0);
  gradExcX += komplex(-K1(1) * sin(theta), K1(1) * cos(theta));
  gradExcY += komplex(-K1(2) * sin(theta), K1(2) * cos(theta));
  gradExcZ += komplex(-K1(3) * sin(theta), K1(3) * cos(theta));
  
  theta = point3d::dot(K2,X-X0);
  gradExcX += komplex(-K2(1) * sin(theta), K2(1) * cos(theta));
  gradExcY += komplex(-K2(2) * sin(theta), K2(2) * cos(theta));
  gradExcZ += komplex(-K2(3) * sin(theta), K2(3) * cos(theta));
  
  theta = point3d::dot(K3,X-X0);
  gradExcX += komplex(-K3(1) * sin(theta), K3(1) * cos(theta));
  gradExcY += komplex(-K3(2) * sin(theta), K3(2) * cos(theta));
  gradExcZ += komplex(-K3(3) * sin(theta), K3(3) * cos(theta));
  
  theta = point3d::dot(K4,X-X0);
  gradExcX += komplex(-K4(1) * sin(theta), K4(1) * cos(theta));
  gradExcY += komplex(-K4(2) * sin(theta), K4(2) * cos(theta));
  gradExcZ += komplex(-K4(3) * sin(theta), K4(3) * cos(theta));
  
  theta = point3d::dot(K5,X-X0);
  gradExcX += komplex(-K5(1) * sin(theta), K5(1) * cos(theta));
  gradExcY += komplex(-K5(2) * sin(theta), K5(2) * cos(theta));
  gradExcZ += komplex(-K5(3) * sin(theta), K5(3) * cos(theta));
  
  theta = point3d::dot(K6,X-X0);
  gradExcX += komplex(-K6(1) * sin(theta), K6(1) * cos(theta));
  gradExcY += komplex(-K6(2) * sin(theta), K6(2) * cos(theta));
  gradExcZ += komplex(-K6(3) * sin(theta), K6(3) * cos(theta));
