...
int main(int argc, char *argv[])
{
  ...
  FeCard.resizeEnrichedDof(10);
  FeCard.getEnrichedDof(1)  = 1;
  FeCard.getEnrichedDof(2)  = 2;
  FeCard.getEnrichedDof(3)  = 3;
  FeCard.getEnrichedDof(4)  = 4;
  FeCard.getEnrichedDof(5)  = 5;
  FeCard.getEnrichedDof(6)  = 6;
  FeCard.getEnrichedDof(7)  = 7;
  FeCard.getEnrichedDof(8)  = 8;
  FeCard.getEnrichedDof(9)  = 9;
  FeCard.getEnrichedDof(10) = 10;
