...
int main(int argc, char *argv[])
{
  ...
  cout << "Tetra vol: " << supporter.tetraVolume(nodes) << endl;
  
  
  sVect<point3d> wedge(6);
  wedge(1) = point3d(1.0, 0.0, 0.0);
  wedge(2) = point3d(1.0, 1.0, 0.0);
  wedge(3) = point3d(0.0, 1.0, 0.0);
  wedge(4) = point3d(2.0, 1.0, 1.0);
  wedge(5) = point3d(2.0, 2.0, 1.0);
  wedge(6) = point3d(1.0, 2.0, 1.0);
  
  cout << "Wedge vol: " << supporter.wedgeVolume(wedge) << endl;
}
