...
int main(int argc, char *argv[])
{
  ...
  if(world->rank() == 0)
  {
    ...
    pItem.setLid(1); pItem.setGid(2); pItem.setShared(false); grphItem(1) = 1; grphItem(2) = 5; grphItem(3) = 6; grafo.push_back(pItem,grphItem);
    pItem.setLid(2); pItem.setGid(1); pItem.setShared(true);  grphItem(1) = 1; grphItem(2) = 2; grphItem(3) = 5; grafo.push_back(pItem,grphItem);
    pItem.setLid(3); pItem.setGid(4); pItem.setShared(true);  grphItem(1) = 2; grphItem(2) = 4; grphItem(3) = 5; grafo.push_back(pItem,grphItem);
    pItem.setLid(4); pItem.setGid(3); pItem.setShared(true);  grphItem(1) = 2; grphItem(2) = 3; grphItem(3) = 4; grafo.push_back(pItem,grphItem);
  ...
  else
  {
    ...
    pItem.setLid(1); pItem.setGid(4); pItem.setShared(true);  grphItem(1) = 1; grphItem(2) = 5; grphItem(3) = 6; grafo.push_back(pItem,grphItem);
    pItem.setLid(2); pItem.setGid(3); pItem.setShared(true);  grphItem(1) = 1; grphItem(2) = 2; grphItem(3) = 5; grafo.push_back(pItem,grphItem);
    pItem.setLid(3); pItem.setGid(5); pItem.setShared(true);  grphItem(1) = 2; grphItem(2) = 4; grphItem(3) = 5; grafo.push_back(pItem,grphItem);
    pItem.setLid(4); pItem.setGid(6); pItem.setShared(false); grphItem(1) = 2; grphItem(2) = 3; grphItem(3) = 4; grafo.push_back(pItem,grphItem);
...
3
 map:  pid: 0 lid: 3 gid: 4 shared: 1 owned 0
 data: Num Connected  : 3
...
pid: 0 lid: 6 gid: 6 shared: 0 owned 1
*/
...
ROW
1
 map:  pid: 1 lid: 1 gid: 4 shared: 1 owned 1
 data: Num Connected  : 3
Connected Id's : 1 5 6 
...
4
 map:  pid: 1 lid: 4 gid: 6 shared: 0 owned 1
 data: Num Connected  : 3
Connected Id's : 2 3 4 
...
pid: 1 lid: 3 gid: 7 shared: 0 owned 1
pid: 1 lid: 4 gid: 8 shared: 0 owned 1
