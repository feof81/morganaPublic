...
int main(int argc, char *argv[])
{
  ...
  if(world->rank() == 0)
  {
    ...
    pItem.setLid(1); pItem.setGid(4); newMap.push_back(pItem);
    pItem.setLid(2); pItem.setGid(3); newMap.push_back(pItem);
    pItem.setLid(3); pItem.setGid(5); newMap.push_back(pItem);
    pItem.setLid(4); pItem.setGid(6); newMap.push_back(pItem);
  ...
  else
  {
    ...
    pItem.setLid(1); pItem.setGid(2); newMap.push_back(pItem);
    pItem.setLid(2); pItem.setGid(1); newMap.push_back(pItem);
    pItem.setLid(3); pItem.setGid(4); newMap.push_back(pItem);
    pItem.setLid(4); pItem.setGid(3); newMap.push_back(pItem);
...
pid: 0 lid: 6 gid: 8 shared: 0 owned 1
*/
