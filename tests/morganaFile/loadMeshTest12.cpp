...
int main(int argc, char *argv[])
{
  ...
  string meshfile = "./geometries/rectangles2d/rectangleA.msh";
  ...
  GRAPH1D   elements1d, elements1dB;
  ...
  loader.gmMeshParallel(meshfile,world,nodesB,elements2dB,elements1dB);
