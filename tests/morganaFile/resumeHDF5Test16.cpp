...
int main(int argc, char *argv[])
{
  ...
  if(world.rank() == 0)
  {
    ...
    map.push_back(pMapItemShare(4,6,0,false,true)); data.push_back(point3d(0.0, 0.0, 7.5));
    map.push_back(pMapItemShare(5,7,0,false,true)); data.push_back(point3d(0.0, 0.0, 8.5));
  }
