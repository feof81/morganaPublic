...
int main(int argc, char *argv[])
{
  ...
  sArray<string> functions(3,3);
  functions(1,1) = "x * x"; functions(1,2) = "x * y"; functions(1,3) = "x * z";
  functions(2,1) = "y * x"; functions(2,2) = "y * y"; functions(2,3) = "y * z";
  functions(3,1) = "z * x"; functions(3,2) = "z * y"; functions(3,3) = "z * z";
