...
int main(int argc, char *argv[])
{
  ...
  else
  {
    ...
    pItem.setLid(3); pItem.setGid(4); colMap.push_back(pItem);
    pItem.setLid(4); pItem.setGid(5); colMap.push_back(pItem);
    
    pItem.setLid(1); pItem.setGid(5); grphItem(1) = 1; grphItem(2) = 3; grphItem(3) = 4; grphItem.setGeoId(2); grafo.push_back(pItem,grphItem);
    pItem.setLid(2); pItem.setGid(6); grphItem(1) = 1; grphItem(2) = 2; grphItem(3) = 3; grphItem.setGeoId(2); grafo.push_back(pItem,grphItem);
  ...
  resumer.printToFile("grafo",grafo);
  resumer.loadFromFile("grafo",rGraph);
