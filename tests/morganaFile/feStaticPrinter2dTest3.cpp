...
int main(int argc, char *argv[])
{
  ...
  string meshFile = "./geometries/rectangles2d/rectangleC.msh";
  ...
  feStaticField2d<FETYPE,DOFTYPE,dms2d_vectMajor,dms2d_allMode> field2d;
  ...
  feStaticField2dGlobalManip<FETYPE,DOFTYPE,dms2d_vectMajor,dms2d_allMode> manipulator(world);
  ...
  typedef feStaticField2d<FETYPE,DOFTYPE,dms2d_vectMajor,dms2d_allMode> FIELD2D;
  feStaticFieldPrinter2d<FIELD2D>  meshPrinter(world);
  
  string s = "testField";
  meshPrinter.printHDF5_nodes(s,pid,field2d);
}
