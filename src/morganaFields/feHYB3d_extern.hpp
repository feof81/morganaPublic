...
#ifndef FEHYB3D_EXTERN_HPP
#define FEHYB3D_EXTERN_HPP
...
//-------------------------------------------------------------------------------------------------
template<typename PMAPTYPE>
typename feHYB3d_extern<PMAPTYPE>::FECARDS
feHYB3d_extern<PMAPTYPE>::
