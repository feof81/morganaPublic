...
#ifndef FESTATICDOFCARD3D_H
#define FESTATICDOFCARD3D_H
...
/*! Information dof-card for the static 3d fields */
class feStaticDofCard3d
{
    /*! @name Internal data */ //@{
  public:
  ...
  public:
    ...
    feStaticDofCard3d operator=(const feStaticDofCard3d & F);
    //@}
  ...
  public:
    ...
    /*! @name Printout */ //@{
  public:
    friend ostream & operator<<(ostream & f, const feStaticDofCard3d & V);
    //@}
};
