...
#ifndef FESTATICFIELD2DGLOBALMANIP_HPP
#define FESTATICFIELD2DGLOBALMANIP_HPP
...
/*! Static Field 2d Global Manipulator - empty general class  */
template<typename PMAPTYPE, typename FETYPE, typename DOFTYPE, dms2d_order ORDER = dms2d_vectMajor, dms2d_mode MODE = dms2d_allMode>
class fsf2dGlobalManip;
...
class fsf2dGlobalManip<pMapItem,FETYPE,DOFTYPE,ORDER,MODE>
{
    /*! @name Typedefs */ //@{
  public:
    typedef pMapItem                                   PMAPTYPE;
    typedef dofMapStatic2d_options                     OPTIONS;
    typedef feStaticField2d<FETYPE,DOFTYPE,ORDER,MODE> FIELD;
  ...
  public:
    fsf2dGlobalManip();
    fsf2dGlobalManip(const Teuchos::RCP<communicator> & CommDev);
    fsf2dGlobalManip(communicator & CommDev);
...
//-------------------------------------------------------------------------------------------------
template<typename FETYPE, typename DOFTYPE, dms2d_order ORDER, dms2d_mode MODE>
fsf2dGlobalManip<pMapItem,FETYPE,DOFTYPE,ORDER,MODE>::
fsf2dGlobalManip()
{
  commDevLoaded = false;
}
                ...
                FIELD          & Field)
{
  ...
  {
    assert(grid2d->getElements().getRowMapL(i).getLid() == i);
        ...
        const set<UInt>      & activeIds)
{
  ...
  UInt geoId;
  OUTTYPE outVal;
  Teuchos::RCP<MESH2D> grid2d = Field.getMesh();
...
template<typename FETYPE, typename DOFTYPE, dms2d_order ORDER, dms2d_mode MODE>
class fsf2dGlobalManip<pMapItemShare,FETYPE,DOFTYPE,ORDER,MODE>
{
    /*! @name Typedefs */ //@{
  public:
...
//-------------------------------------------------------------------------------------------------
template<typename FETYPE, typename DOFTYPE, dms2d_order ORDER, dms2d_mode MODE>
fsf2dGlobalManip<pMapItemShare,FETYPE,DOFTYPE,ORDER,MODE>::
fsf2dGlobalManip()
{
  commDevLoaded = false;
}
...
bool
fsf2dGlobalManip<pMapItemShare,FETYPE,DOFTYPE,ORDER,MODE>::
initilize(const sArray<string> & exprString, const Teuchos::RCP<FIELD> & Field)
{
  return(initilize(exprString,*Field));
}
...
class feStaticField2dGlobalManip : public fsf2dGlobalManip<typename FETYPE::FETYPE_PMAPTYPE,FETYPE,DOFTYPE,ORDER,MODE>
{
     /*! @name Typedefs */ //@{
  public:
    ...
    /*! @name Constructors */ //@{
  public:
    feStaticField2dGlobalManip();
    feStaticField2dGlobalManip(const Teuchos::RCP<communicator> & CommDev);
    feStaticField2dGlobalManip(communicator & CommDev);
    //@}
};


template<typename FETYPE, typename DOFTYPE, dms2d_order ORDER, dms2d_mode MODE>
feStaticField2dGlobalManip<FETYPE,DOFTYPE,ORDER,MODE>::
feStaticField2dGlobalManip() : fsf2dGlobalManip<typename FETYPE::FETYPE_PMAPTYPE,FETYPE,DOFTYPE,ORDER,MODE>()
{
...
template<typename FETYPE, typename DOFTYPE, dms2d_order ORDER, dms2d_mode MODE>
feStaticField2dGlobalManip<FETYPE,DOFTYPE,ORDER,MODE>::
feStaticField2dGlobalManip(const Teuchos::RCP<communicator> & CommDev) : fsf2dGlobalManip<typename FETYPE::FETYPE_PMAPTYPE,FETYPE,DOFTYPE,ORDER,MODE>(CommDev)
{
  assert(staticAssert<GEOSHAPE::nDim == 2>::returnValue);
}
...
template<typename FETYPE, typename DOFTYPE, dms2d_order ORDER, dms2d_mode MODE>
feStaticField2dGlobalManip<FETYPE,DOFTYPE,ORDER,MODE>::
feStaticField2dGlobalManip(communicator & CommDev) : fsf2dGlobalManip<typename FETYPE::FETYPE_PMAPTYPE,FETYPE,DOFTYPE,ORDER,MODE>(CommDev)
{
  assert(staticAssert<GEOSHAPE::nDim == 2>::returnValue);
}
