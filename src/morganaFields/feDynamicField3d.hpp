...
class feDynamicField3d
{
  ...
  public:
    ...
    typedef feDynamicInterface3d<FETYPE,DOFTYPE,ORDER,MODE> FEINTERFACE;
  ...
  public:
    feDynamicField3d();
    feDynamicField3d(const Teuchos::RCP<communicator> & CommDev, const Teuchos::RCP<MESH3D> & Grid3d, const Teuchos::RCP<CONNECT3D> & ConnedGrid3d);
    feDynamicField3d(communicator & CommDev, MESH3D & Grid3d, CONNECT3D & ConnedGrid3d);
    feDynamicField3d(const Teuchos::RCP<DOFMAPPER> & DofMapper);
    feDynamicField3d(const DOFMAPPER & DofMapper);
    feDynamicField3d(const feDynamicField3d & Field);
    feDynamicField3d & operator=(const feDynamicField3d & Field);
    void clone(const feDynamicField3d & Field);
    //@}
...
feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::
feDynamicField3d()
{
...
template<typename FETYPE, typename DOFTYPE, dmd3d_order ORDER, dmd3d_mode MODE>
typename feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::feDynamicField3d &
feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::
operator=(const feDynamicField3d & Field)
{
  commLoaded     = Field.commLoaded;
  geometryLoaded = Field.geometryLoaded;
  optionsLoaded  = Field.optionsLoaded;
...
void
feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::
clone(const feDynamicField3d & Field)
{
  commLoaded     = Field.commLoaded;
  geometryLoaded = Field.geometryLoaded;
  optionsLoaded  = Field.optionsLoaded;
...
template<typename FETYPE, typename DOFTYPE, dmd3d_order ORDER, dmd3d_mode MODE>
Teuchos::RCP<typename feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::MESH3D>
feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::
getMesh3d() const
{
...
template<typename FETYPE, typename DOFTYPE, dmd3d_order ORDER, dmd3d_mode MODE>
Teuchos::RCP<typename feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::CONNECT3D>
feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::
...
template<typename FETYPE, typename DOFTYPE, dmd3d_order ORDER, dmd3d_mode MODE>
const typename feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::DOFMAPPER &
feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::
getDofMapper() const
{
  assert(startupOk);
...
template<typename FETYPE, typename DOFTYPE, dmd3d_order ORDER, dmd3d_mode MODE>
const typename feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::ELCARDFEEDER &
feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::
...
template<typename FETYPE, typename DOFTYPE, dmd3d_order ORDER, dmd3d_mode MODE>
const typename feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::FECARDS &
feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::
getFeCards() const
{
...
template<typename FETYPE, typename DOFTYPE, dmd3d_order ORDER, dmd3d_mode MODE>
typename feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::FECARDS &
feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::
getFeCards()
{
  return(dofMapper->getFeCards());
...
template<typename FETYPE, typename DOFTYPE, dmd3d_order ORDER, dmd3d_mode MODE>
const typename feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::OPTIONS
feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::
getOptions() const
{
...
template<typename FETYPE, typename DOFTYPE, dmd3d_order ORDER, dmd3d_mode MODE>
const
typename feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::DOFVECT &
feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::
getDofVect() const
{
  assert(startupOk);
...
template<typename FETYPE, typename DOFTYPE, dmd3d_order ORDER, dmd3d_mode MODE>
typename feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::LISTVECT
feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::
getList() const
{
  assert(startupOk);
...
template<typename FETYPE, typename DOFTYPE, dmd3d_order ORDER, dmd3d_mode MODE>
const
typename feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::LISTMAP &
feDynamicField3d<FETYPE,DOFTYPE,ORDER,MODE>::
getListMap() const
{
  assert(startupOk);
...
{
  assert(startupOk);
  assert(grid3d->getElements().isRowG(elG));
