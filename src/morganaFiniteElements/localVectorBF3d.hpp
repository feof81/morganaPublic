...
#ifndef LOCALVECTORBF3D_HPP
#define LOCALVECTORBF3D_HPP

#include "morganaIntegrator.hpp"
#include "intTableFBF3d.hpp"
...
class localVectorBF3d
{
  ...
  public:
    static const intClass DEFAULTCLASS = intTableFBF3d< TEST_FETYPE::feBaseLabel >::intFlag;
  ...
  public:
    localVectorBF3d();
    localVectorBF3d(const Teuchos::RCP<FUNCTIONAL> & Op);
...
localVectorBF3d<TEST,INT_CLASS,INT_TYPE,INT_PRECISION>::
localVectorBF3d()
{
  assert(staticAssert<INTEGRATOR::opFlag == fnBF3d>::returnValue);
  opLoaded = false;
}
