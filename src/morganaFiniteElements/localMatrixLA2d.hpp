...
#ifndef LOCALMATRIXLA2D_HPP
#define LOCALMATRIXLA2D_HPP

#include "morganaIntegrator.hpp"
#include "intTableLA2d.hpp"
...
class localMatrixLA2d
{
  ...
  public:
    static const intClass DEFAULTCLASS = intTableLA2d< FIELD_FETYPE::feBaseLabel, TEST_FETYPE::feBaseLabel >::intFlag;
  ...
  public:
    localMatrixLA2d();
    localMatrixLA2d(const Teuchos::RCP<OPERATOR> & Op);
...
localMatrixLA2d<FIELD,TEST,INT_CLASS,INT_TYPE,INT_PRECISION>::
localMatrixLA2d()
{
  assert(staticAssert<INTEGRATOR::opFlag == opLA2d>::returnValue);
  opLoaded = false;
}
