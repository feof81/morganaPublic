...
#ifndef OPERATORBB3D_HPP
#define OPERATORBB3D_HPP
...
class operatorBB3d
{
  ...
  public:
    ...
    typedef mesh2d<GEOSHAPE2D,FIELD_PMAPTYPE,FIELD_PMAPTYPE>     MESH2D;
    typedef connect2d<GEOSHAPE2D,FIELD_PMAPTYPE,FIELD_PMAPTYPE>  CONNECT2D;
  ...
  public:
    operatorBB3d();
    operatorBB3d(const Teuchos::RCP<communicator> & CommDev, const Teuchos::RCP<MESH3D> & Grid3d, const Teuchos::RCP<CONNECT3D> & ConnectGrid3d, const Teuchos::RCP<MESH2D> & Grid2d, const Teuchos::RCP<CONNECT2D> & ConnectGrid2d);
    operatorBB3d(communicator & CommDev, MESH3D & Grid3d, CONNECT3D & ConnectGrid3d, MESH2D & Grid2d, CONNECT2D & ConnectGrid2d);
    virtual ~operatorBB3d() {};
...
template<typename FIELD, typename TEST>
const Teuchos::RCP<typename operatorBB3d<FIELD,TEST>::MESH3D> &
operatorBB3d<FIELD,TEST>::
getLoopGrid() const
{
  return(grid3d);
...
template<typename FIELD, typename TEST>
const typename operatorBB3d<FIELD,TEST>::FIELD_LISTMAP &
operatorBB3d<FIELD,TEST>::
...
template<typename FIELD, typename TEST>
const typename operatorBB3d<FIELD,TEST>::TEST_LISTMAP &
operatorBB3d<FIELD,TEST>::
...
//-------------------------------------------------------------------------------------------------
template<typename FIELD, typename TEST>
const typename operatorBB3d<FIELD,TEST>::FIELD_FECARD &
operatorBB3d<FIELD,TEST>::
getFeCardL_field()
{
  assert(startupOk);
...
template<typename FIELD, typename TEST>
const typename operatorBB3d<FIELD,TEST>::TEST_FECARD &
operatorBB3d<FIELD,TEST>::
getFeCardL_test()
{
  assert(startupOk);
...
template<typename FIELD, typename TEST>
typename operatorBB3d<FIELD,TEST>::ELCARD
operatorBB3d<FIELD,TEST>::
getElCard() const
{
  assert(startupOk);
...
template<typename FIELD, typename TEST>
const Teuchos::RCP<typename operatorBB3d<FIELD,TEST>::INTGRID> &
operatorBB3d<FIELD,TEST>::
