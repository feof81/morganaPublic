...
#ifndef LOCALMATRIXEL2D_HPP
#define LOCALMATRIXEL2D_HPP

#include "morganaIntegrator.hpp"
#include "intTableEL2d.hpp"
...
class localMatrixEL2d
{
  ...
  public:
    static const intClass DEFAULTCLASS = intTableEL2d<FIELD_FETYPE::feBaseLabel,TEST_FETYPE::feBaseLabel>::intFlag;
  ...
  public:
    localMatrixEL2d();
    localMatrixEL2d(const Teuchos::RCP<OPERATOR> & Op);
...
localMatrixEL2d<FIELD,TEST,INT_CLASS,INT_TYPE,INT_PRECISION>::
localMatrixEL2d()
{
  assert(staticAssert<INTEGRATOR::opFlag == opEL2d>::returnValue);
  opLoaded = false;
}
