...
#ifndef LOCALVECTORBF2D_HPP
#define LOCALVECTORBF2D_HPP

#include "morganaIntegrator.hpp"
#include "intTableFBF2d.hpp"
...
class localVectorBF2d
{
  ...
  public:
    static const intClass DEFAULTCLASS = intTableFBF2d< TEST_FETYPE::feBaseLabel >::intFlag;
  ...
  public:
    localVectorBF2d();
    localVectorBF2d(const Teuchos::RCP<FUNCTIONAL> & Op);
...
localVectorBF2d<TEST,INT_CLASS,INT_TYPE,INT_PRECISION>::
localVectorBF2d()
{
  assert(staticAssert<INTEGRATOR::opFlag == fnBF2d>::returnValue);
  opLoaded = false;
}
