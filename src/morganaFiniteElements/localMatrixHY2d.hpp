...
#ifndef LOCALMATRIXHY2D_HPP
#define LOCALMATRIXHY2D_HPP

#include "morganaIntegrator.hpp"
#include "intTableHY2d.hpp"
...
class localMatrixHY2d
{
  ...
  public:
    static const intClass DEFAULTCLASS = intTableHY2d<FIELD_FETYPE::feBaseLabel,TEST_FETYPE::feBaseLabel>::intFlag;
  ...
  public:
    localMatrixHY2d();
    localMatrixHY2d(const Teuchos::RCP<OPERATOR> & Op);
...
localMatrixHY2d<FIELD,TEST,INT_CLASS,INT_TYPE,INT_PRECISION>::
localMatrixHY2d()
{
  assert(staticAssert<INTEGRATOR::opFlag == opHY2d>::returnValue);
  opLoaded = false;
}
