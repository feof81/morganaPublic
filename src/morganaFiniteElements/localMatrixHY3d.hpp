...
#ifndef LOCALMATRIXHY3D_HPP
#define LOCALMATRIXHY3D_HPP

#include "morganaIntegrator.hpp"
#include "intTableHY3d.hpp"
...
/*! Local matrix -> Operarator for hybrid FE 3d */
template<typename FIELD, typename TEST, intClass INT_CLASS = intDefault, intTypes INT_TYPE = HYBRID, UInt INT_PRECISION = 1>
class localMatrixHY3d
{
  /*! @name Typedefs */ //@{
  public:
  ...
  public:
    static const intClass DEFAULTCLASS = intTableHY3d<FIELD_FETYPE::feBaseLabel,TEST_FETYPE::feBaseLabel>::intFlag;
  ...
  public:
    localMatrixHY3d();
    localMatrixHY3d(const Teuchos::RCP<OPERATOR> & Op);
...
localMatrixHY3d<FIELD,TEST,INT_CLASS,INT_TYPE,INT_PRECISION>::
localMatrixHY3d()
{
  assert(staticAssert<INTEGRATOR::opFlag == opHY3d>::returnValue);
  opLoaded = false;
}
