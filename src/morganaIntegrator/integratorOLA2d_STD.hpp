...
#ifndef INTEGRATOROLA2D_STD_HPP
#define INTEGRATOROLA2D_STD_HPP
...
class integratorOLA2d_STD
{
  ...
  public:
    ...
    /*! @name Internal data */ //@{
  public:
    static const intClass intFlag = OLA2d_STD;
    static const OPType   opFlag  = opLA2d;
  ...
  public:
    ...
    /*! Constructor */
    integratorOLA2d_STD(const INTCARD & IntCard);
...
//-------------------------------------------------------------------------------------------------
template<typename OPERATOR, intTypes TYPE, UInt PRECISION>
integratorOLA2d_STD<OPERATOR,TYPE,PRECISION>::
integratorOLA2d_STD()
{
