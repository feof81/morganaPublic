...
#ifndef INTEGRATORFHY3D_STC_HPP
#define INTEGRATORFHY3D_STC_HPP
...
class integratorFHY3d_STC
{
  ...
  public:        
    ...
    /*! @name Internal data */ //@{
  public:
    static const intClass intFlag = FHY3d_STC;
  ...
  public:
    ...
    /*! Constructor */
    integratorFHY3d_STC(const INTCARD & IntCard);
...
//-------------------------------------------------------------------------------------------------
template<typename FUNCTIONAL, intTypes TYPE, UInt PRECISION>
integratorFHY3d_STC<FUNCTIONAL,TYPE,PRECISION>::
integratorFHY3d_STC()
{
