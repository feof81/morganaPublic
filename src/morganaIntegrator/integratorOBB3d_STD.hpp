...
#ifndef INTEGRATOROBB3D_STD_HPP
#define INTEGRATOROBB3D_STD_HPP
...
class integratorOBB3d_STD
{
  ...
  public:
    ...
    /*! @name Internal data */ //@{
  public:
    static const intClass intFlag = OBB3d_STD;
  ...
  public:
    ...
    /*! Constructor */
    integratorOBB3d_STD(const INTCARD & IntCard);
...
//-------------------------------------------------------------------------------------------------
template<typename OPERATOR, intTypes TYPE, UInt PRECISION>
integratorOBB3d_STD<OPERATOR,TYPE,PRECISION>::
integratorOBB3d_STD()
{
