...
#ifndef INTEGRATORFLA3D_STD_HPP
#define INTEGRATORFLA3D_STD_HPP
...
class integratorFLA3d_STD
{
  ...
  public:
    ...
    /*! @name Internal data */ //@{
  public:
    static const intClass intFlag = FLA3d_STD;
  ...
  public:
    ...
    /*! Constructor */
    integratorFLA3d_STD(const INTCARD & IntCard);
...
//-------------------------------------------------------------------------------------------------
template<typename FUNCTIONAL, intTypes TYPE, UInt PRECISION>
integratorFLA3d_STD<FUNCTIONAL,TYPE,PRECISION>::
integratorFLA3d_STD()
{
