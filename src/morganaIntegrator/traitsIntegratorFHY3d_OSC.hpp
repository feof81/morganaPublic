...
#ifndef TRAITSINTEGRATORFHY3D_OSC_HPP
#define TRAITSINTEGRATORFHY3D_OSC_HPP
...
class traitsIntegratorFHY3d_OSC
{ };
...
class traitsIntegratorFHY3d_OSC<FUNCTIONAL,linearTriangle,TYPE,PRECISION>
{
    /*! @name Typedefs */ //@{
  public:   
    ...
    /*! @name Internal data */ //@{
  public:
    static const intClass intFlag = FHY3d_OSC;
  ...
  public:
    /*! Constructor */
    traitsIntegratorFHY3d_OSC();
    
    /*! Constructor */
    traitsIntegratorFHY3d_OSC(const INTCARD & IntCard);
...
template<typename FUNCTIONAL, intTypes TYPE, UInt PRECISION>
traitsIntegratorFHY3d_OSC<FUNCTIONAL,linearTriangle,TYPE,PRECISION>::
traitsIntegratorFHY3d_OSC()
{
  //Assert
