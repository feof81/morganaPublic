...
#ifndef INTEGRATOROBB2D_STD_HPP
#define INTEGRATOROBB2D_STD_HPP
...
class integratorOBB2d_STD
{
  ...
  public:
    ...
    /*! @name Internal data */ //@{
  public:
    static const intClass intFlag = OBB2d_STD;
  ...
  public:
    ...
    /*! Constructor */
    integratorOBB2d_STD(const INTCARD & IntCard);
...
//-------------------------------------------------------------------------------------------------
template<typename OPERATOR, intTypes TYPE, UInt PRECISION>
integratorOBB2d_STD<OPERATOR,TYPE,PRECISION>::
integratorOBB2d_STD()
{
