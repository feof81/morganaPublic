...
#ifndef INTEGRATOROBB3D_STC_HPP
#define INTEGRATOROBB3D_STC_HPP
...
class integratorOBB3d_STC
{
  ...
  public:
    ...
    /*! @name Internal data */ //@{
  public:
    static const intClass intFlag = OBB3d_STC;
  ...
  public:
    ...
    /*! Constructor */
    integratorOBB3d_STC(const INTCARD & IntCard);
...
//-------------------------------------------------------------------------------------------------
template<typename OPERATOR, intTypes TYPE, UInt PRECISION>
integratorOBB3d_STC<OPERATOR,TYPE,PRECISION>::
integratorOBB3d_STC()
{
