...
#ifndef INTEGRATORFBF3D_STD_HPP
#define INTEGRATORFBF3D_STD_HPP
...
class integratorFBF3d_STD
{
  ...
  public:
    ...
    /*! @name Internal data */ //@{
  public:
    static const intClass intFlag = FBF3d_STD;
  ...
  public:
    ...
    /*! Constructor */
    integratorFBF3d_STD(const INTCARD & IntCard);
...
//-------------------------------------------------------------------------------------------------
template<typename FUNCTIONAL, intTypes TYPE, UInt PRECISION>
integratorFBF3d_STD<FUNCTIONAL,TYPE,PRECISION>::
integratorFBF3d_STD()
{
