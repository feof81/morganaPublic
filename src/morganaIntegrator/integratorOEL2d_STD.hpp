...
#ifndef INTEGRATOROEL2D_STD_HPP
#define INTEGRATOROEL2D_STD_HPP
...
/*! Standard 3d integrator for oscillating functions (operator) */
template<typename OPERATOR, intTypes TYPE, UInt PRECISION>
class integratorOEL2d_STD
{
    /*! @name Typedefs */ //@{
  public:
    ...
    /*! @name Internal data */ //@{
  public:
    static const intClass intFlag = OEL2d_STD;
  ...
  public:
    ...
    /*! Constructor */
    integratorOEL2d_STD(const INTCARD & IntCard);
...
//-------------------------------------------------------------------------------------------------
template<typename OPERATOR, intTypes TYPE, UInt PRECISION>
integratorOEL2d_STD<OPERATOR,TYPE,PRECISION>::
integratorOEL2d_STD()
{
