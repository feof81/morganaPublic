...
#ifndef INTEGRATOROLA3D_STD_HPP
#define INTEGRATOROLA3D_STD_HPP
...
class integratorOLA3d_STD
{
  ...
  public:
    ...
    /*! @name Internal data */ //@{
  public:
    static const intClass intFlag = OLA3d_STD;
  ...
  public:
    ...
    /*! Constructor */
    integratorOLA3d_STD(const INTCARD & IntCard);
...
//-------------------------------------------------------------------------------------------------
template<typename OPERATOR, intTypes TYPE, UInt PRECISION>
integratorOLA3d_STD<OPERATOR,TYPE,PRECISION>::
integratorOLA3d_STD()
{
