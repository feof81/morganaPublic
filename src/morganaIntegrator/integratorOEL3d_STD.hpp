...
#ifndef INTEGRATOROEL3D_STD_HPP
#define INTEGRATOROEL3D_STD_HPP
...
class integratorOEL3d_STD
{
  ...
  public:
    ...
    /*! @name Internal data */ //@{
  public:
    static const intClass intFlag = OEL3d_STD;
  ...
  public:
    ...
    /*! Constructor */
    integratorOEL3d_STD(const INTCARD & IntCard);
...
//-------------------------------------------------------------------------------------------------
template<typename OPERATOR, intTypes TYPE, UInt PRECISION>
integratorOEL3d_STD<OPERATOR,TYPE,PRECISION>::
integratorOEL3d_STD()
{
