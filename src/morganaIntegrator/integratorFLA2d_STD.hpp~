...
#ifndef INTEGRATORFLA2D_STD_HPP
#define INTEGRATORFLA2D_STD_HPP
...
/*! Integrates on a single boundary edge of a 2d mesh (edge is pre-set) */
template<typename FUNCTIONAL, intTypes TYPE, UInt PRECISION>
class integratorFLA2d_STD
{
    /*! @name Typedefs */ //@{
  public:
    ...
    /*! @name Internal data */ //@{
  public:
    static const intClass intFlag = FLA2d_STD;
    static const OPType   opFlag  = fnLA2d;
  ...
  public:
    ...
    /*! Constructor */
    integratorFLA2d_STD(const INTCARD & IntCard);
...
//-------------------------------------------------------------------------------------------------
template<typename FUNCTIONAL, intTypes TYPE, UInt PRECISION>
integratorFLA2d_STD<FUNCTIONAL,TYPE,PRECISION>::
integratorFLA2d_STD()
{
