...
#ifndef TRAITSINTEGRATOROLA3D_OSC_HPP
#define TRAITSINTEGRATOROLA3D_OSC_HPP
...
class traitsIntegratorOLA3d_OSC
{ };
...
class traitsIntegratorOLA3d_OSC<OPERATOR,linearTriangle,TYPE,PRECISION>
{
    /*! @name Typedefs */ //@{
  public:
    ...
    typedef TEST_GEOSHAPE             GEOSHAPE2D;
    ...
    /*! @name Internal data */ //@{
  public:
    static const intClass intFlag = OLA3d_OSC;
  ...
  public:
    /*! Constructor */
    traitsIntegratorOLA3d_OSC();
    
    /*! Constructor */
    traitsIntegratorOLA3d_OSC(const INTCARD & IntCard);
...
template<typename OPERATOR, intTypes TYPE, UInt PRECISION>
traitsIntegratorOLA3d_OSC<OPERATOR,linearTriangle,TYPE,PRECISION>::
traitsIntegratorOLA3d_OSC()
{
  //Typedefs
  ...
  assert(staticAssert<GEOPROOF::geoName    == TEST_GEOSHAPE::geoName>::returnValue);
...
integration(OPERATOR & op)
{
  ...
  sVect<point3d> nodes2d = op.getElCard().getNodes();
