...
#ifndef TRAITSINTEGRATOROBB3D_OSC_HPP
#define TRAITSINTEGRATOROBB3D_OSC_HPP
...
class traitsIntegratorOBB3d_OSC
{ };
...
class traitsIntegratorOBB3d_OSC<OPERATOR,linearTriangle,TYPE,PRECISION>
{
    /*! @name Typedefs */ //@{
  public:
    ...
    /*! @name Internal data */ //@{
  public:
    static const intClass intFlag = OBB3d_OSC;
    static const OPType   opFlag  = opBB3d;
  ...
  public:
    /*! Constructor */
    traitsIntegratorOBB3d_OSC();
    
    /*! Constructor */
    traitsIntegratorOBB3d_OSC(const INTCARD & IntCard);
...
template<typename OPERATOR, intTypes TYPE, UInt PRECISION>
traitsIntegratorOBB3d_OSC<OPERATOR,linearTriangle,TYPE,PRECISION>::
traitsIntegratorOBB3d_OSC()
{
  //Typedefs
