...
class fnBF3dE : public functionalBF3d<TEST>
{
    /*! @name Typedefs */ //@{
  public:
  ...
  public:
    fnBF3dE();
    fnBF3dE(const Teuchos::RCP<communicator> & CommDev,
...
eval(const point3d & Yf, sVect<Real> & mat)
{
  ...
  { mat(j) = (point3d::dot(eval_field(j), val)); }
}
