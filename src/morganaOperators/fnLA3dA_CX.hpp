...
#ifndef FNLA3DA_CX_HPP
#define FNLA3DA_CX_HPP
...
/*!  Functional: u * v complex test function, real coefficient */
template<typename TEST, typename GEOSHAPE3D, typename COEFF>
class fnLA3dA_CX : public functionalLA3d<TEST,GEOSHAPE3D>
{
    /*! @name Typedefs */ //@{
  public:
  ...
  public:
    fnLA3dA_CX();
    fnLA3dA_CX(const Teuchos::RCP<communicator> & CommDev,
    ...
    fnLA3dA_CX(communicator & CommDev,
               MESH3D       & Grid3d,
...
//-------------------------------------------------------------------------------------------------
template<typename TEST, typename GEOSHAPE3D, typename COEFF>
fnLA3dA_CX<TEST,GEOSHAPE3D,COEFF>::
fnLA3dA_CX() : functionalLA3d<TEST,GEOSHAPE3D>()
{
