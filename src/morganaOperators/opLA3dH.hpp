...
/*! Operator 2d : (U * Q) / coeffV */
template<typename FIELD, typename TEST, typename COEFFV>
class opLA3dH : public operatorLA3d<FIELD,TEST>
{
  /*! @name Typedefs */ //@{
  public:
  ...
  public:
    opLA3dH();
    opLA3dH(const Teuchos::RCP<communicator> & CommDev,
...
template<typename FIELD, typename TEST, typename COEFFV>
opLA3dH<FIELD,TEST,COEFFV>::
opLA3dH() : operatorLA3d<FIELD,TEST>()
{
