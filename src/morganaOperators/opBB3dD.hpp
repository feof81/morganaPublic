...
class opBB3dD : public operatorBB3d<FIELD,TEST>
{
    /*! @name Typedefs */ //@{
  public:
  ...
  public:
    opBB3dD();
    opBB3dD(const Teuchos::RCP<communicator> & CommDev,
...
template<typename FIELD, typename TEST, typename COEFF>
opBB3dD<FIELD,TEST,COEFF>::
opBB3dD() : operatorBB3d<FIELD,TEST>()
{
