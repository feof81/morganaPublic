...
class opEL3dA : public operatorEL3d<FIELD,TEST>
{
    /*! @name Typedefs */ //@{
  public:
  ...
  public:
    opEL3dA();
    opEL3dA(const Teuchos::RCP<communicator> & CommDev, const Teuchos::RCP<MESH3D> & Grid3d, const Teuchos::RCP<CONNECT3D> & ConnedGrid3d);
    opEL3dA(communicator & CommDev, MESH3D & Grid3d, CONNECT3D & ConnedGrid3d);
...
//-------------------------------------------------------------------------------------------------
template<typename FIELD, typename TEST, typename COEFF>
opEL3dA<FIELD,TEST,COEFF>::
opEL3dA() : operatorEL3d<FIELD,TEST>()
{
...
template<typename FIELD, typename TEST, typename COEFF>
opEL3dA<FIELD,TEST,COEFF>::
opEL3dA(const Teuchos::RCP<communicator> & CommDev,
...
template<typename FIELD, typename TEST, typename COEFF>
opEL3dA<FIELD,TEST,COEFF>::
opEL3dA(communicator & CommDev, MESH3D & Grid3d, CONNECT3D & ConnedGrid3d) : operatorEL3d<FIELD,TEST>(CommDev,Grid3d,ConnedGrid3d)
{
  assert(staticAssert<traitsBasic<FIELD_OUTTYPE>::myType == typeReal>::returnValue);
  assert(staticAssert<traitsBasic<TEST_OUTTYPE>::myType  == typeReal>::returnValue);
  assert(staticAssert<traitsBasic<COEFF_OUTTYPE>::myType == typeReal>::returnValue);
