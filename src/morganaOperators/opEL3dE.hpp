...
class opEL3dE : public operatorEL3d<FIELD,TEST>
{
    /*! @name Typedefs */ //@{
  public:
  ...
  public:
    opEL3dE();
    opEL3dE(const Teuchos::RCP<communicator> & CommDev,
            const Teuchos::RCP<MESH3D>       & Grid3d,
            const Teuchos::RCP<CONNECT3D>    & ConnedGrid3d);
    
    opEL3dE(communicator & CommDev,
            MESH3D       & Grid3d,
...
//-------------------------------------------------------------------------------------------------
template<typename FIELD, typename TEST, typename COEFF>
opEL3dE<FIELD,TEST,COEFF>::
opEL3dE() : operatorEL3d<FIELD,TEST>()
{
