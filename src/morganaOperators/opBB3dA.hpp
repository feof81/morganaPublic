...
/*! Operator 3d : coeff * u * v */
template<typename FIELD, typename TEST>
class opBB3dA : public operatorBB3d<FIELD,TEST>
{
    /*! @name Typedefs */ //@{
  public:
  ...
  public:
    opBB3dA();
    opBB3dA(const Teuchos::RCP<communicator> & CommDev,
...
template<typename FIELD, typename TEST>
opBB3dA<FIELD,TEST>::
opBB3dA() : operatorBB3d<FIELD,TEST>()
{
...
template<typename FIELD, typename TEST>
opBB3dA<FIELD,TEST>::
opBB3dA(communicator & CommDev, MESH3D & Grid3d, CONNECT3D & ConnedGrid3d, MESH2D & Grid2d, CONNECT2D & ConnedGrid2d) 
: operatorBB3d<FIELD,TEST>(CommDev,Grid3d,ConnedGrid3d,Grid2d,ConnedGrid2d)
{
  assert(staticAssert<traitsBasic<FIELD_OUTTYPE>::myType == typeReal>::returnValue);
  assert(staticAssert<traitsBasic<TEST_OUTTYPE>::myType  == typeReal>::returnValue);
