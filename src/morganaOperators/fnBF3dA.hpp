...
/*! Functional 3d: - (V * N) coeff */
template<typename TEST, typename COEFF>
class fnBF3dA : public functionalBF3d<TEST>
{
    /*! @name Typedefs */ //@{
  public:
  ...
  public:
    fnBF3dA();
    fnBF3dA(const Teuchos::RCP<communicator> & CommDev, const Teuchos::RCP<MESH3D> & Grid3d, const Teuchos::RCP<CONNECT3D> & ConnectGrid3d, const Teuchos::RCP<MESH2D> & Grid2d, const Teuchos::RCP<CONNECT2D> & ConnectGrid2d);
    fnBF3dA(communicator & CommDev, MESH3D & Grid3d, CONNECT3D & ConnectGrid3d, MESH2D & Grid2d, CONNECT2D & ConnectGrid2d);
