...
class fnEL3dF : public functionalEL3d<TEST>
{
  /*! @name Typedefs */ //@{
  public:
  ...
  public:
    fnEL3dF();
    fnEL3dF(const Teuchos::RCP<communicator> & CommDev, const Teuchos::RCP<MESH3D> & Grid3d, const Teuchos::RCP<CONNECT3D> & ConnedGrid3d);
    fnEL3dF(communicator & CommDev, MESH3D & Grid3d, CONNECT3D & ConnedGrid3d);
...
//-------------------------------------------------------------------------------------------------
template<typename TEST, typename COEFFA, typename COEFFB>
fnEL3dF<TEST,COEFFA,COEFFB>::
fnEL3dF() : functionalEL3d<TEST>()
{
...
template<typename TEST, typename COEFFA, typename COEFFB>
fnEL3dF<TEST,COEFFA,COEFFB>::
fnEL3dF(const Teuchos::RCP<communicator> & CommDev, const Teuchos::RCP<MESH3D> & Grid3d, const Teuchos::RCP<CONNECT3D> & ConnedGrid3d) : functionalEL3d<TEST>(CommDev,Grid3d,ConnedGrid3d)
{
  assert(staticAssert<traitsBasic<TEST_OUTTYPE>::myType   == typeReal>::returnValue);
  assert(staticAssert<traitsBasic<COEFFA_OUTTYPE>::myType == typeReal>::returnValue);
  assert(staticAssert<traitsBasic<COEFFB_OUTTYPE>::myType == typeReal>::returnValue);
...
template<typename TEST, typename COEFFA, typename COEFFB>
fnEL3dF<TEST,COEFFA,COEFFB>::
fnEL3dF(communicator & CommDev, MESH3D & Grid3d, CONNECT3D & ConnedGrid3d) : functionalEL3d<TEST>(CommDev,Grid3d,ConnedGrid3d)
{
  assert(staticAssert<traitsBasic<TEST_OUTTYPE>::myType   == typeReal>::returnValue);
  assert(staticAssert<traitsBasic<COEFFA_OUTTYPE>::myType == typeReal>::returnValue);
  assert(staticAssert<traitsBasic<COEFFB_OUTTYPE>::myType == typeReal>::returnValue);
