...
#ifndef BELOSBLOCKGMRES_HPP
#define BELOSBLOCKGMRES_HPP
...
class belosBlockGmres : public virtualLinearSolver<SCALARTYPE,MV,OP>
{
...
template<typename SCALARTYPE, typename MV, typename OP>
belosBlockGmres<SCALARTYPE,MV,OP>::
belosBlockGmres() : virtualLinearSolver<SCALARTYPE,MV,OP>()
{
}
...
solve()
{
  ...
  typedef Belos::BlockGmresSolMgr<SCALARTYPE,MV,OP> BELOS_SOLVER;
