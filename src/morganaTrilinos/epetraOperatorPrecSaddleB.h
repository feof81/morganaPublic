...
#ifndef EPETRAOPERATORPRECSADDLEB_H
#define EPETRAOPERATORPRECSADDLEB_H
...
class epetraOperatorPrecSaddleB : public Epetra_Operator
{
  /*! @name Typedefs */ //@{
  public:
  ...
  public:
    ...
    Teuchos::RCP<Teuchos::ParameterList>    solList;
    //@}
