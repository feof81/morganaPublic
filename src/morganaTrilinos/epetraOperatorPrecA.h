...
#ifndef EPETRAOPERATORPRECA_H
#define EPETRAOPERATORPRECA_H
...
/*! Projection operator */
class epetraOperatorPrecA : public Epetra_Operator
{  
    /*! @name Typedefs */ //@{
  public:
  ...
  public:
    epetraOperatorPrecA();
    epetraOperatorPrecA(const Teuchos::RCP<Belos::EpetraPrecOp> & A,
                        const Teuchos::RCP<Epetra_MultiVector>  & V);
    
    epetraOperatorPrecA(const epetraOperatorPrecA & op);
    
    epetraOperatorPrecA operator=(const epetraOperatorPrecA & op);
