...
#ifndef BELOSLSQR_HPP
#define BELOSLSQR_HPP
...
class belosLSQR : public virtualLinearSolver<SCALARTYPE,MV,OP>
{
...
template<typename SCALARTYPE, typename MV, typename OP>
belosLSQR<SCALARTYPE,MV,OP>::
belosLSQR() : virtualLinearSolver<SCALARTYPE,MV,OP>()
{
}
...
solve()
{
  ...
  typedef Belos::LSQRSolMgr<SCALARTYPE,MV,OP>     BELOS_SOLVER;
